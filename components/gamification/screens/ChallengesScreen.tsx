      ...
      >
        ...
        {isCompleted ? (
          <View style={styles.completedBadge}>
            <Icon name="check-circle" size={18} color="white" style={styles.completedIcon} />
          ...
          <View style={styles.progressContainer}>
            ...
            <Text style={styles.progressText}>
              {userRewards.currentChallenges.find(c => c.id === item.id)?.progress || 0}%
            </Text>
          </View>
        ) : (
          <TouchableOpacity 
            style={[
              styles.joinButton,
              isSelected && styles.joiningButton
            ]}
          ...
          >
            {isSelected ? (
              ...
              <>
                <Icon name="plus-circle" size={18} color="white" style={styles.joinIcon} />
